...
//        }
//
//        // 강의 코드 목록을 추출하여 계약 과정 조회
//        List<Long> lectureCodes = lectures.stream()
//                .map(LectureDTO::getLectureCode)
//                .collect(Collectors.toList());
//
//        // 강의 코드로 계약 과정 조회
//        List<ContractProcessDTO> contractProcesses = contractProcessRepository.findByLecture_LectureCodeIn(lectureCodes);
//
//        if (contractProcesses.isEmpty()) {
